...
wget https://raw.githubusercontent.com/yk271/Actions-OpenWrt/refs/heads/main/lienol/default-settings -O ./my-default-settings
cat ./my-default-settings >> ./package/default-settings/files/zzz-default-settings
